...
4. Instantiate an object, or objects, in `main()` method of the `Module1CodingAssessment` class, and use the objects to test your methods.
You may use the main method in Module1CodingAssessment.java.   
